...
function haslost() {
	for(let r = 0; r < rows; r++) {
		for(let c = 0; c < columns; c++) {
			...
			if(
				r > 0 && board [r-1][c] === currentTile || // compares currentTile and adj. above.
				r < rows - 1 && board[r+1][c] === currentTile || // compares currentTile and tile below
				c > 0 && board[r][c-1] === currentTile || // compares currentTile to the adj tile to the left
